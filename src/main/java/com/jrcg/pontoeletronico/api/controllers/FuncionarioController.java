...
import com.jrcg.pontoeletronico.api.dtos.FuncionarioDto;
...
public class FuncionarioController {
	...
	/**
	 * Atualiza os dados de um funcioanrio.
	 * 
	 * @param id
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar (@PathVariable("id") Long id,
		...
		if (result.hasErrors()) {
			log.error("Erro validando funcinario: {}", result.getAllErrors());
	...
	/**
	 * Atualiza funcionário com base nos dados encontrados no DTO.
	 * @param funcionario
	 * @param funcionarioDto
	 * @param result
	 * @throws NoSuchAlgorithmException
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasAlmocoOpt().ifPresent(
				qtdHorasAlmoco -> funcionarioDto.setQtdHoraAlmoco(Optional.of(Float.toString(qtdHorasAlmoco))));
