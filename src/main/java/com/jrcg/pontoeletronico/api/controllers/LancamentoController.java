...
import com.jrcg.pontoeletronico.api.dtos.LancamentoDto;
...
import com.jrcg.pontoeletronico.api.services.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
		...
		if (!lancamento.isPresent()) {
			...
			response.getErrors().add("Lançamento naõ encontrado para o ID " + id);
	 ...
	 * @param lancamentoDto
	 * @param result
	 * @return Response<Response<LancamentoDto>>
	 * @throws ParseException
	 */
	...
	/**
	 * Validar um funcionário, verficando se ele é existente no sistema.
	 * 
	 * @param lancamentoDto
	 * @param result
	 */
	...
	/**
	 * Converte uma entidade laçamento para seu respectivo DTO.
	 * 
	 * @param lancamento
